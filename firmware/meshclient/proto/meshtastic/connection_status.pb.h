...
#define meshtastic_WifiConnectionStatus_init_default {false, meshtastic_NetworkConnectionStatus_init_default, {{NULL}, NULL}, 0}
...
#define meshtastic_WifiConnectionStatus_init_zero {false, meshtastic_NetworkConnectionStatus_init_zero, {{NULL}, NULL}, 0}
...
#define meshtastic_WifiConnectionStatus_CALLBACK pb_default_field_callback
...
/* meshtastic_DeviceConnectionStatus_size depends on runtime parameters */
/* meshtastic_WifiConnectionStatus_size depends on runtime parameters */
#define MESHTASTIC_MESHTASTIC_CONNECTION_STATUS_PB_H_MAX_SIZE meshtastic_BluetoothConnectionStatus_size
