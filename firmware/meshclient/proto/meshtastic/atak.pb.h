...
typedef struct _meshtastic_AircraftTrack {
    ...
    pb_callback_t registration;
    /* Flight number/callsign (e.g. "ASA864") */
    pb_callback_t flight;
    /* ICAO aircraft type designator (e.g. "B39M") */
    pb_callback_t aircraft_type;
...
typedef struct _meshtastic_CasevacReport {
   ...
   bit 4: blood */
    ...
    uint32_t litter_patients;
    /* Line 5: number of ambulatory (walking-wounded) patients. */
    uint32_t ambulatory_patients;
 ...
 (e.g. "Green smoke", "VS-17 panel west"). Capped tight in options. */
    pb_callback_t zone_marker;
    /* --- Line 8: patient nationality counts --- */
    uint32_t us_military;
    uint32_t us_civilian;
    uint32_t non_us_military;
    uint32_t non_us_civilian;
    uint32_t epw; /* enemy prisoner of war */
    uint32_t child;
...
#define meshtastic_GeoChat_init_default          {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, _meshtastic_GeoChat_ReceiptType_MIN, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define meshtastic_AircraftTrack_init_default    {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0, {{NULL}, NULL}, 0, 0, {{NULL}, NULL}}
#define meshtastic_CotGeoPoint_init_default      {0, 0}
#define meshtastic_DrawnShape_init_default       {_meshtastic_DrawnShape_Kind_MIN, _meshtastic_DrawnShape_StyleMode_MIN, 0, 0, 0, _meshtastic_Team_MIN, 0, 0, _meshtastic_Team_MIN, 0, 0, 0, 0, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_Marker_init_default           {_meshtastic_Marker_Kind_MIN, _meshtastic_Team_MIN, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_RangeAndBearing_init_default  {false, meshtastic_CotGeoPoint_init_default, {{NULL}, NULL}, 0, 0, _meshtastic_Team_MIN, 0, 0}
#define meshtastic_Route_init_default            {_meshtastic_Route_Method_MIN, _meshtastic_Route_Direction_MIN, {{NULL}, NULL}, 0, {{NULL}, NULL}, 0}
#define meshtastic_Route_Link_init_default       {false, meshtastic_CotGeoPoint_init_default, {{NULL}, NULL}, {{NULL}, NULL}, 0}
#define meshtastic_CasevacReport_init_default    {_meshtastic_CasevacReport_Precedence_MIN, 0, 0, 0, _meshtastic_CasevacReport_Security_MIN, _meshtastic_CasevacReport_HlzMarking_MIN, {{NULL}, NULL}, 0, 0, 0, 0, 0, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0, 0, 0, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_ZMistEntry_init_default       {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_EmergencyAlert_init_default   {_meshtastic_EmergencyAlert_Type_MIN, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_TaskRequest_init_default      {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, _meshtastic_TaskRequest_Priority_MIN, _meshtastic_TaskRequest_Status_MIN, {{NULL}, NULL}}
...
#define meshtastic_TAKPacketV2_init_default      {_meshtastic_CotType_MIN, _meshtastic_CotHow_MIN, {{NULL}, NULL}, _meshtastic_Team_MIN, _meshtastic_MemberRole_MIN, 0, 0, 0, 0, 0, 0, _meshtastic_GeoPointSource_MIN, _meshtastic_GeoPointSource_MIN, {{NULL}, NULL}, {{NULL}, NULL}, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, meshtastic_TAKEnvironment_init_default, false, meshtastic_SensorFov_init_default, false, meshtastic_Marti_init_default, 0, {meshtastic_GeoChat_init_default}}
...
#define meshtastic_GeoChat_init_zero             {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, _meshtastic_GeoChat_ReceiptType_MIN, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define meshtastic_AircraftTrack_init_zero       {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0, {{NULL}, NULL}, 0, 0, {{NULL}, NULL}}
#define meshtastic_CotGeoPoint_init_zero         {0, 0}
#define meshtastic_DrawnShape_init_zero          {_meshtastic_DrawnShape_Kind_MIN, _meshtastic_DrawnShape_StyleMode_MIN, 0, 0, 0, _meshtastic_Team_MIN, 0, 0, _meshtastic_Team_MIN, 0, 0, 0, 0, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_Marker_init_zero              {_meshtastic_Marker_Kind_MIN, _meshtastic_Team_MIN, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_RangeAndBearing_init_zero     {false, meshtastic_CotGeoPoint_init_zero, {{NULL}, NULL}, 0, 0, _meshtastic_Team_MIN, 0, 0}
#define meshtastic_Route_init_zero               {_meshtastic_Route_Method_MIN, _meshtastic_Route_Direction_MIN, {{NULL}, NULL}, 0, {{NULL}, NULL}, 0}
#define meshtastic_Route_Link_init_zero          {false, meshtastic_CotGeoPoint_init_zero, {{NULL}, NULL}, {{NULL}, NULL}, 0}
...
#define meshtastic_EmergencyAlert_init_zero      {_meshtastic_EmergencyAlert_Type_MIN, {{NULL}, NULL}, {{NULL}, NULL}}
#define meshtastic_TaskRequest_init_zero         {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, _meshtastic_TaskRequest_Priority_MIN, _meshtastic_TaskRequest_Status_MIN, {{NULL}, NULL}}
...
#define meshtastic_TAKPacketV2_init_zero         {_meshtastic_CotType_MIN, _meshtastic_CotHow_MIN, {{NULL}, NULL}, _meshtastic_Team_MIN, _meshtastic_MemberRole_MIN, 0, 0, 0, 0, 0, 0, _meshtastic_GeoPointSource_MIN, _meshtastic_GeoPointSource_MIN, {{NULL}, NULL}, {{NULL}, NULL}, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, meshtastic_TAKEnvironment_init_zero, false, meshtastic_SensorFov_init_zero, false, meshtastic_Marti_init_zero, 0, {meshtastic_GeoChat_init_zero}}
...
X(a, CALLBACK, SINGULAR, STRING,   receipt_for_uid,   4) \
...
X(a, CALLBACK, SINGULAR, STRING,   icao,              1) \
X(a, CALLBACK, SINGULAR, STRING,   registration,      2) \
X(a, CALLBACK, SINGULAR, STRING,   flight,            3) \
X(a, CALLBACK, SINGULAR, STRING,   aircraft_type,     4) \
X(a, STATIC,   SINGULAR, UINT32,   squawk,            5) \
X(a, CALLBACK, SINGULAR, STRING,   category,          6) \
X(a, STATIC,   SINGULAR, SINT32,   rssi_x10,          7) \
X(a, STATIC,   SINGULAR, BOOL,     gps,               8) \
X(a, CALLBACK, SINGULAR, STRING,   cot_host_id,       9)
#define meshtastic_AircraftTrack_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   bullseye_uid_ref,  17) \
...
X(a, CALLBACK, SINGULAR, STRING,   parent_uid,        5) \
X(a, CALLBACK, SINGULAR, STRING,   parent_type,       6) \
X(a, CALLBACK, SINGULAR, STRING,   parent_callsign,   7) \
X(a, CALLBACK, SINGULAR, STRING,   iconset,           8)
#define meshtastic_Marker_CALLBACK pb_default_field_callback
#define meshtastic_Marker_DEFAULT NULL

#define meshtastic_RangeAndBearing_FIELDLIST(X, a) \
X(a, STATIC,   OPTIONAL, MESSAGE,  anchor,            1) \
X(a, CALLBACK, SINGULAR, STRING,   anchor_uid,        2) \
...
#define meshtastic_RangeAndBearing_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   prefix,            3) \
X(a, STATIC,   SINGULAR, UINT32,   stroke_weight_x10,   4) \
X(a, CALLBACK, REPEATED, MESSAGE,  links,             5) \
X(a, STATIC,   SINGULAR, BOOL,     truncated,         6)
#define meshtastic_Route_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   callsign,          3) \
X(a, STATIC,   SINGULAR, UINT32,   link_type,         4)
#define meshtastic_Route_Link_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   zone_marker,       7) \
...
X(a, CALLBACK, SINGULAR, STRING,   frequency,        15) \
...
X(a, CALLBACK, SINGULAR, STRING,   authoring_uid,     2) \
X(a, CALLBACK, SINGULAR, STRING,   cancel_reference_uid,   3)
#define meshtastic_EmergencyAlert_CALLBACK pb_default_field_callback
#define meshtastic_EmergencyAlert_DEFAULT NULL

#define meshtastic_TaskRequest_FIELDLIST(X, a) \
X(a, CALLBACK, SINGULAR, STRING,   task_type,         1) \
X(a, CALLBACK, SINGULAR, STRING,   target_uid,        2) \
X(a, CALLBACK, SINGULAR, STRING,   assignee_uid,      3) \
X(a, STATIC,   SINGULAR, UENUM,    priority,          4) \
X(a, STATIC,   SINGULAR, UENUM,    status,            5) \
X(a, CALLBACK, SINGULAR, STRING,   note,              6)
#define meshtastic_TaskRequest_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   uid,              14) \
X(a, CALLBACK, SINGULAR, STRING,   device_callsign,  15) \
X(a, STATIC,   SINGULAR, UINT32,   stale_seconds,    16) \
X(a, CALLBACK, SINGULAR, STRING,   tak_version,      17) \
X(a, CALLBACK, SINGULAR, STRING,   tak_device,       18) \
X(a, CALLBACK, SINGULAR, STRING,   tak_platform,     19) \
X(a, CALLBACK, SINGULAR, STRING,   tak_os,           20) \
X(a, CALLBACK, SINGULAR, STRING,   endpoint,         21) \
X(a, CALLBACK, SINGULAR, STRING,   phone,            22) \
X(a, CALLBACK, SINGULAR, STRING,   cot_type_str,     23) \
...
X(a, CALLBACK, ONEOF,    BYTES,    (payload_variant,raw_detail,payload_variant.raw_detail),  33) \
...
/* meshtastic_AircraftTrack_size depends on runtime parameters */
/* meshtastic_DrawnShape_size depends on runtime parameters */
/* meshtastic_Marker_size depends on runtime parameters */
/* meshtastic_RangeAndBearing_size depends on runtime parameters */
/* meshtastic_Route_size depends on runtime parameters */
/* meshtastic_Route_Link_size depends on runtime parameters */
/* meshtastic_CasevacReport_size depends on runtime parameters */
/* meshtastic_ZMistEntry_size depends on runtime parameters */
/* meshtastic_EmergencyAlert_size depends on runtime parameters */
/* meshtastic_TaskRequest_size depends on runtime parameters */
