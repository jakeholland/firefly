...
PB_BIND(meshtastic_StoreForwardPlusPlus, meshtastic_StoreForwardPlusPlus, AUTO)
...
PB_BIND(meshtastic_MqttClientProxyMessage, meshtastic_MqttClientProxyMessage, AUTO)
...
PB_BIND(meshtastic_ClientNotification, meshtastic_ClientNotification, AUTO)
