...
#define meshtastic_LockdownAuth_init_default     {{{NULL}, NULL}, 0, 0, 0, 0, 0}
#define meshtastic_HamParameters_init_default    {{{NULL}, NULL}, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define meshtastic_LockdownAuth_init_zero        {{{NULL}, NULL}, 0, 0, 0, 0, 0}
#define meshtastic_HamParameters_init_zero       {{{NULL}, NULL}, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}}
...
X(a, CALLBACK, SINGULAR, STRING,   long_name,         5)
